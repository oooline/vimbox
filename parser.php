...
if($en){
    load_entities('doc-en/en/extensions.ent');
    load_entities('doc-en/doc-base/entities/global.ent');
    load_entities('doc-en/en/language-defs.ent');
    load_entities('doc-en/en/language-snippets.ent');
    #load_entities('doc-en/zh/livedocs.ent');
    load_entities('doc-en/en/contributors.ent');
    process_all('doc-en/en/reference');

    $zh = false;
}

if($zh){
    load_entities('doc-zh/zh/extensions.ent');
    load_entities('doc-zh/zh/language-defs.ent');
    load_entities('doc-zh/zh/language-snippets.ent');
    #load_entities('doc-zh/zh/livedocs.ent');
    #load_entities('doc-zh/zh/contributors.ent');
    process_all('doc-zh/zh/reference');
}
